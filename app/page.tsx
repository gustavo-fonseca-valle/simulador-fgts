  ...
  return (
    <main className="max-w-screen-sm sm:max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mt-16">
        <h2 className="text-2xl font-semibold mb-6">Perguntas frequentes sobre FGTS</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="font-semibold">Quem recebe multa de 40%?</h3>
            <p className="text-gray-700">
              Trabalhadores demitidos sem justa causa têm direito à multa sobre o saldo do FGTS.
            </p>
          </div>
